                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url()?>/assets/admin/images/logo-icon.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="<?php echo base_url()?>/assets/admin/images/logo-text.png" alt="homepage" class="light-logo" />
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-move-resize-variant"></i><span class="hide-menu">Data Cabang </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <span class="hide-menu"> Pengiriman On Process </span></a></li>
                                <li class="sidebar-item"><a href="<?php echo site_url()?>/Client/belumKirim" class="sidebar-link"><i class="mdi mdi-multiplication-box"></i>
