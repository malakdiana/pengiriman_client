              ...
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab"><?php echo form_open('Home/cekResi'); ?>
                <div class="block-17">
                  <form action="" method="post" class="d-block d-lg-flex">
                    ...
                    <?php echo form_close();?>
                   <br>
                      <table id="zero_config" class="table table-dark">
                                        <thead>
                                            <tr>
                                    <td><b>Tanggal</b></td>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($lokasi as $key ) { ?>
                                    ...
                                    <tr>
                                    <?php 
                                        if($key->asal != $key->tujuan){
                                    if( $key->status == 'On Process'){ ?>
                                    <tr>
                                        
                                        <td><?php echo $key->tanggal?></td>
                                        <td>barang diterima di <?php echo $key->asal ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $key->tanggal?></td>
                                        <td>barang dikirim dari <?php echo $key->asal ?> ke <?php echo $key->tujuan; ?> oleh <?php echo $key->nama; ?></td>
                                    </tr>
                                        <?php }else { ?>
                                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $key->tanggal?></td>
                                        <td>barang sampai ke <?php echo $key->tujuan; ?> </td></tr>
                                        <?php }
                                            }else{
                                        if( $key->status == 'On Process'){ ?>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><?php echo $key->tanggal?></td>
                                        <td>barang dikirim dari <?php echo $key->asal ?> ke alamat <?php echo $key->alamatPenerima; ?> oleh <?php echo $key->nama; ?></td>
                                    </tr>
                                        <?php }else { ?>
                                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $key->tanggal?></td>
                                        <td>barang sampai ke alamat <?php echo $key->alamatPenerima; ?> di terima oleh <?php echo $key->namaPenerima?> </td></tr>
                                        <?php }}}?>
